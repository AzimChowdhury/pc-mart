        ...
        <div>
            <div className="hero min-h-screen ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src={data.img} className=" w-96 rounded-lg shadow-2xl" />
                    <div>
                ...
                <div className='mx-auto max-w-fit'>
                    {
                        data?.review?.map((review, index) =>
                            <div key={index} className='flex my-2 items-center'>
                                <img className='w-12  border-2 rounded-3xl border-black' src="https://icon-library.com/images/person-png-icon/person-png-icon-29.jpg" alt="" />
